...
const Inv = {
  ...
  DEF: {
    ...
    sand:       { name: 'Grit Sand',    glyph: 'sand',        value: 1,  desc: 'Ground stone, sharp as salt. Melts into glass.' },
    ...
    beam:       { name: 'Oak Beam',     glyph: 'beam',        value: 34, desc: 'Heavy timber. Holds up whatever you build.' },
    ingot:      { name: 'Iron Ingot',   art: 'res_ingot',     value: 16, desc: 'One bar of clean iron, still warm.' },
    glass:      { name: 'Sea Glass',    glyph: 'glass',       value: 22, desc: 'Melted grit, cooled slow and clear.' },
    crystal:    { name: 'Sea Crystal',  art: 'res_crystal',   value: 26, desc: 'Cold, clear, and faintly humming.' },
    lens:       { name: 'Crystal Lens', glyph: 'lens',        value: 64, desc: 'Ground and polished. It gathers light.' },
    cannonball: { name: 'Cannonball',   glyph: 'ball',        value: 12, desc: 'Shell grit packed hard. Fits the deck cannon.' },
    crabpot:    { name: 'Crab Pot',     glyph: 'pot',  value: 30, stack: 20, desc: 'Sink it off the dock overnight.' },
    ...
    pick_stone:   { name: 'Stone Pick',   glyph: 'pick', tone: 1, value: 70,  stack: 1, hot: 'pick_stone',   desc: 'Bites coal, iron and scrap.' },
    pick_iron:    { name: 'Iron Pick',    glyph: 'pick', tone: 2, value: 220, stack: 1, hot: 'pick_iron',    desc: 'Splits gold and sunken wrecks.' },
    pick_crystal: { name: 'Crystal Pick', glyph: 'pick', tone: 3, value: 620, stack: 1, hot: 'pick_crystal', desc: 'The only thing that touches crystal.' },
